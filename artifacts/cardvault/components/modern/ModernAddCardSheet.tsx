...
interface ModernAddCardSheetProps {
  visible: boolean;
  onClose: () => void;
}
      ...
      <View style={styles.modalRoot}>
        ...
        <View style={[styles.sheet, { paddingBottom: Math.max(insets.bottom, 18), height: '92%' }]}>
          ...
          <View style={styles.sheetHeader}>
            <View>
              <Text style={styles.sheetEyebrow}>ADD NEW ENTRY</Text>
              <Text style={styles.sheetTitle}>Secure card details</Text>
            </View>
            <Pressable
          ...
          >
            ...
            >
              <Text style={[styles.saveButtonText, { color: canSave ? '#000000' : '#8C8C8C' }]}>
                Save card
              </Text>
              <Ionicons name="arrow-forward" size={16} color={canSave ? '#000000' : '#8C8C8C'} />
            </Pressable>
            </ScrollView>
          </KeyboardAvoidingView>
        </View>
